...
},{"isarray":"node_modules/has-binary2/node_modules/isarray/index.js","buffer":"../../../.config/yarn/global/node_modules/buffer/index.js"}],"node_modules/arraybuffer.slice/index.js":[function(require,module,exports) {
/**
  ...
  switch (action.type) {
    case _actions.PathActionEnum.APPEND_TO_PATH:
      ...
      if (Array.isArray(action.toAppend)) {
        pathArr = state.pathArr.concat(action.toAppend);
      } else {
        pathArr = state.pathArr.concat([action.toAppend]);
      }
...
var deckEditorReducer = function deckEditorReducer(state, action) {
  ...
  switch (action.type) {
    ...
    case _actions.DeckEditorEnum.ADD_CARD:
      var cards = state.deck.cards.concat([action.card]);
      return __assign({}, state, {
        deck: __assign({}, state.deck, {
          cards: cards
        }),
    ...
    case _actions.DeckEditorEnum.ADD_STYLE:
      var styles = state.deck.styles.concat([action.style]);
      return __assign({}, state, {
        deck: __assign({}, state.deck, {
          styles: styles
        }),
...
var _default = function _default(_a) {
  ...
  return (0, _preact.h)("div", {
    ...
    return (0, _preact.h)(_deckItem.default, {
      deck: deck,
...
},{"./actions":"src/deckBuilder/actions.ts","../state/store":"src/state/store.ts","../util":"src/util.ts"}],"node_modules/decko/dist/decko.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"src/components/deckBuilder/styleList.tsx":[function(require,module,exports) {
"use strict";
...
},{"preact":"node_modules/preact/dist/preact.mjs","preact-redux":"node_modules/preact-redux/dist/preact-redux.esm.js","./src/state/store":"src/state/store.ts","./src/components/app":"src/components/app.tsx"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
