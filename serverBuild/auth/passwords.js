...
exports.verifyToken = (token) => __awaiter(this, void 0, void 0, function* () {
    ...
    const hash = yield makeHash(b64, userHash);
...
exports.verifyPasswordForUser = (username, password) => __awaiter(this, void 0, void 0, function* () {
    const user = yield db_1.userRepo.findOne({ username });
    if (!user) {
        throw "Couldn't find user: " + username;
    }
