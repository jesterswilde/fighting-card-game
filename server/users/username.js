...
var generateUsername = function () {
    var firstIndex = Math.floor(Math.random() * nouns_1.nouns.length);
    var secondIndex;
...
exports.makeValidUsername = function () { return __awaiter(void 0, void 0, void 0, function () {
    var username, lookingForName, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!lookingForName) return [3 /*break*/, 3];
